...
This isn't just my story. The data is converging, and it's not flattering.

A 1,488-worker study on AI adoption found that heavy AI users reported *more* mental fatigue, not less. Cognitive effort didn't disappear; it shifted from execution to review and correction. Reviewing AI output is harder than doing routine work. It requires holding the full problem in your head while evaluating someone else's answer. It's expensive in a different way, and there's no obvious recovery window.

HBR's February 2026 paper made it plainer: AI tools caused workers to take on a faster pace and broader scope. The time savings didn't materialize into rest or focus. People just did more, under more pressure, at higher speed.
...
Multiply by async. You come back from a meeting to a queue of agent outputs, each waiting for a decision. That's not a lighter afternoon. That's decision fatigue, pre-loaded.

Agent count is not a capacity proxy. It's a workload multiplier, and it front-loads the cost onto whoever is doing the orchestrating. Usually your best engineers. The ones you can least afford to burn.

---

## What managing through it looks like

My engineers who are deep in AI right now are, mostly, having the time of their lives. They're shipping more than they ever have. They're learning languages they've never touched by asking AI to build things in them and studying the output. The energy is real. I'm not going to pretend otherwise.

But I'm checking in on them. Not because anything's wrong — because I've read enough, and felt enough of this myself, to know that the high and the crash aren't always that far apart.
...
The feeling I can't shake: this creeping anxiety when you don't have enough queued for the agents. Like you're failing to maximize something you're supposed to be maximizing. That feeling is data. It's the system pulling you toward always-on orchestration, toward Bezos Mode by default, toward the exact failure pattern this piece is about.

Yegge, Banerjee, Huntley pushed until they crashed. The nap-strike. The sleep disruption. The grinding exhaustion. I don't think any of them predicted how fast it arrived.
...
The question was never whether to use AI. That's settled.

The question is whether you're designing workflows (for yourself and your teams) that can absorb the cognitive cost of agent orchestration. Or whether you're just adding agents and hoping the humans keep up.

More agents means more work. Design for that, or let the crash do it for you.

---

*Sources: [HBR "Brain Fry" study](https://hbr.org/2026/03/generative-ai-when-using-ai-leads-to-brain-fry) (Bedard et al., March 2026, N=1,488) · [Stevey's Birthday Blog](https://steve-yegge.medium.com/steveys-birthday-blog-34f437139cb5) (Yegge, Jan 2026) · [Hanselman interviews Yegge](https://youtu.be/9UDLl9Q0azA?t=666) (YouTube, ~11:06) · [GitHub Copilot 55% faster](https://github.blog/news-insights/research/research-quantifying-github-copilots-impact-in-the-enterprise-with-accenture/) (GitHub + Accenture, 2024)*
