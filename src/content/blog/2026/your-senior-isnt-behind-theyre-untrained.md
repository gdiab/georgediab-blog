...
I have one in mind. I wrote about him a while back, in a [piece about the identity crisis AI created for engineers](https://www.georgediab.com/posts/2026/ai-identity-crisis): a senior I respect who was grieving the part of the craft AI was eroding. He's still in that bottom cohort, but moving, slowly, to the next cohort. He uses the tools for planning and for reviewing, but he isn't convinced they write the best code, and when he hands one a real task he usually ends up re-steering it back on course. Some of that is the model. A lot of it is that he's working in a legacy-ish codebase the agent doesn't have the context to navigate, and he hasn't yet hit the point of frustration where he sits down and writes the codebase's opinions into a CLAUDE.md so the agent stops guessing. The mandate framing would read all of this as resistance to be overcome. It isn't. It's a skilled person making an accurate call about where the tool currently fails him. Even though he's still in that bottom bracket, he's slowly guiding himself (with a bit of help from me) to that next level.

What actually moved him wasn't pressure. It was people. He started trying new models and tools after following voices he already trusted: peers and teachers who'd shaped his growth years ago and have since moved into AI. Matt Pocock is the clearest example: the TypeScript teacher he'd learned from is now teaching AI practices for engineers, much of it [free on his YouTube channel](https://www.youtube.com/@mattpocockuk). That's the lesson I'd hand any manager staring at a holdout: you don't argue a skeptic into the higher cohort, you give them a guide they already respect, a framework to follow, and the room and time to travel the path of levelling up.
...
He's opting in because he's seeing where the puck is headed.
